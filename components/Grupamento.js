const Grupamento = () => (
    ...
    <div id="grupamento">
        ...
        <ul>
            <li><h3 className="subtitle"> GAMT - RJ</h3></li>
            <li>
                <p>
                ...
                <div className="imgGrupamento2">
                    <img src="./static/slider/8.jpg" alt="Preguiça recolhida em via e solta em floresta" />
                    <img src="./static/slider/20.jpg" alt="Acompanhamento e suporte a pesquisas" />
                </div>
            </li>
