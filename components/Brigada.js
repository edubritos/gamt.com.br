const Brigada = () => (
    <div id="brigada">
        ...
        <div className="imgBrigada1 ">
            <img src="./static/slider/16.jpg" alt="Trabalho conjuntos" />
            <img src="./static/slider/10.jpg" alt="Área queimada" />
        </div>
        ...
        <div className="imgBrigada2">
            <img src="./static/slider/1.jpg" alt="Queima controlada de expansão" />
            <img src="./static/slider/30.jpg" alt="Combate a incêndios florestais" />
        </div>
        
        <h4 className="subtitle br">Apoio</h4>
        <div className="parceiras">
            <a href="" >
                <img src="../static/icons/icmbio.jpg" height="100" width="" alt="Instituto Chico Mendes da Biodiversidade" className="border" />
            </a>
            <a href="">
                <img src="../static/icons/prefeitura-rio.png" height="100" alt="Prefeitura do Rio" />
            </a>
            <a href="">
                <img src="../static/icons/inea.jpg" height="100" alt="Inea" />
            </a>
            <a href="">
                <img src="../static/icons/mosaico-carioca.png" height="100" alt="Mosaico Carioca" />
            </a>
            <a href="">
                <img src="../static/icons/ibs.jpg" height="100" alt="IBS" className="border" />
            </a>
            <a href="">
                <img src="../static/icons/pnt.png" height="100" alt="Parque Nacional da Tijuca" className="border" />
            </a>
        </div>
